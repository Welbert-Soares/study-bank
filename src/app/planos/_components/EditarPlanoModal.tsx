...
export function EditarPlanoModal({
  ...
  const loadPlanoData = async () => {
    ...
    try {
      ...
      setImagePreview(plano.emblema || null)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se a imagem foi removida, explicitamente definir como null para remover do banco
      if (imageRemoved) {
        updateData.emblema = null
      } else if (imagePreview) {
        updateData.emblema = imagePreview
      }

      await atualizarPlanoAction(planoId, updateData as Partial<PlanoFormData>)
